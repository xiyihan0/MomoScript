...
export function analyze_text_wasm(text: string): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly __wbg_wasmlanguageserver_free: (a: number, b: number) => void;
    readonly wasmlanguageserver_new: () => number;
