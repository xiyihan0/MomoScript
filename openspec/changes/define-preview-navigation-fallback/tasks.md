...
- [ ] 1.4 Decide upstream contribution timing without blocking normal delivery through the dedicated fork source branch.
...
- [ ] 2.4 Commit the fix to the fork, pin its full source revision, then rebuild and qualify native/WASM Tinymist artifacts from a clean exact checkout.
