...
- `openspec/changes/redesign-dsl-syntax-v2/`：下一版 DSL 语法、`@actor` preset/revision 模型、`[:...:]` 资源标记、`@typ`、正文模式、Rust parser / source map 架构草案
...
- `openspec/changes/redesign-dsl-syntax-v2/typst-template-library.md`：v2 Typst 模板库职责、public façade、主题与位置相关配置状态草案
...
- `openspec/changes/redesign-dsl-syntax-v2/specs/typst-template-library/spec.md`：模板库接口、资源输入与连续消息配置的 capability 草案
